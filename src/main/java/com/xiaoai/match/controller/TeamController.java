...
import com.xiaoai.match.model.request.TeamAddRequest;
...
import com.xiaoai.match.service.TeamService;
...
public class TeamController {
    ...
    public BaseResponse<Boolean> deleteTeamById(@RequestBody int id) {
        if(id <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
